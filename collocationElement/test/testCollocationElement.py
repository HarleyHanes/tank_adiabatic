...
trueBasis = np.array(
    [
        -1 / 6 * (x**3 - 6 * x**2 + 11 * x - 6),
        1 / 2 * (x**3 - 5 * x**2 + 6 * x),
        -1 / 2 * (x**3 - 4 * x**2 + 3 * x),
        1 / 6 * (x**3 - 3 * x**2 + 2 * x),
    ]
)
trueFirstDeriv = np.array(
    [
        -1 / 6 * (3 * x**2 - 12 * x + 11),
        1 / 2 * (3 * x**2 - 10 * x + 6),
        -1 / 2 * (3 * x**2 - 8 * x + 3),
...
trueSecondDeriv = np.array([-1 / 6 * (6 * x - 12), 1 / 2 * (6 * x - 10), -1 / 2 * (6 * x - 8), 1 / 6 * (6 * x - 6)])
...
testElement = CollocationElement.Element(bounds=[-2, -0.5], nCollocation=3, spacing="legendre")


def f(x):
    return 0.5 * (x**5) + x**4 + 2 * (x**3) + 3 * (x**2) + 4 * x + 5
...
testElement = CollocationElement.Element(bounds=[0.5, 4.5], nCollocation=2, spacing="legendre")


def f(x):
    return np.array([4 * x + 3, 2 * (x**3) + 3.4 * (x**2) + 12 * x + 5])
