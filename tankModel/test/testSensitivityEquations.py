...
assert np.isclose(
    dvdvHComputed,
    (-dvdvHx + dvdvHxx / params["PeT"] + params["delta"] * (1 - dvdvH)) / params["Le"],
).all()
...
assert np.isclose(
    ...
    + dudvHxx / params["PeM"]
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
...
assert np.isclose(
    dvdDeltaComputed,
    (-dvdDeltax + dvdDeltaxx / params["PeT"] + params["vH"] - v - params["delta"] * dvdDelta) / params["Le"],
).all()
...
assert np.isclose(
    ...
    (
        -dvdDeltax
        + dvdDeltaxx / params["PeT"]
        + params["Da"]
        * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
        * ((1 - u) * (params["gamma"] * params["beta"] * dvdDelta / (1 + params["beta"] * v) ** 2) - dudDelta)
        + params["vH"]
        - v
        - params["delta"] * dvdDelta
    )
    / params["Le"],
).all()
...
assert np.isclose(
    ...
    * (
        1
        - u
        + params["Da"] * ((1 - u) * (params["gamma"] * params["beta"] * dvdDa / (1 + params["beta"] * v) ** 2) - dudDa)
    ),
).all()
# Check ddvdDadt
assert np.isclose(
    ...
    (
        ...
        * (
            ...
            - u
            + params["Da"]
            * ((1 - u) * (params["gamma"] * params["beta"] * dvdDa / (1 + params["beta"] * v) ** 2) - dudDa)
        )
    )
    / params["Le"],
).all()
...
assert np.isclose(
    dvdgammaComputed,
    (-dvdgammax + dvdgammaxx / params["PeT"] - params["delta"] * dvdgamma) / params["Le"],
).all()
...
assert np.isclose(
    dudgammaComputed,
    -dudgammax
    + dudgammaxx / params["PeM"]
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * (
        (1 - u)
        * params["beta"]
        * (v + params["beta"] * v**2 + params["gamma"] * dvdgamma)
        / (1 + params["beta"] * v) ** 2
        - dudgamma
    ),
).all()
...
assert np.isclose(
    ...
    (
        -dvdgammax
        + dvdgammaxx / params["PeT"]
        - params["delta"] * dvdgamma
        + params["Da"]
        * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
        * (
            (1 - u)
...
assert np.isclose(
    dvdbetaComputed,
    (-dvdbetax + dvdbetaxx / params["PeT"] - params["delta"] * dvdbeta) / params["Le"],
).all()
...
assert np.isclose(
    dudbetaComputed,
    -dudbetax
    + dudbetaxx / params["PeM"]
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * ((1 - u) * params["gamma"] * (v + params["beta"] * dvdbeta) / (1 + params["beta"] * v) ** 2 - dudbeta),
).all()
# Check ddvdgammadt
assert np.isclose(
    dvdbetaComputed,
    (
        -dvdbetax
        + dvdbetaxx / params["PeT"]
        - params["delta"] * dvdbeta
        + params["Da"]
        * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
        * ((1 - u) * params["gamma"] * (v + params["beta"] * dvdbeta) / (1 + params["beta"] * v) ** 2 - dudbeta)
    )
...
assert np.isclose(
    dvdLeComputed,
    (-dvdLex - dvdt + dvdLexx / params["PeT"] - params["delta"] * dvdLe) / params["Le"],
).all()
...
assert np.isclose(
    ...
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * ((1 - u) * (params["gamma"] * params["beta"] * dvdLe / (1 + params["beta"] * v) ** 2) - dudLe),
).all()
# Check ddvdLedt
assert np.isclose(
    dvdLeComputed,
...
assert np.isclose(
    ...
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * ((1 - u) * (params["gamma"] * params["beta"] * dvdPeM / (1 + params["beta"] * v) ** 2) - dudPeM),
).all()
# Check ddvdPeMdt
assert np.isclose(
    dvdPeMComputed,
...
def v(x):
    return -(x**2) + 2 * x + (2 / params["PeT"] + params["f"] * (2 - 1)) / (1 - params["f"])
...
dvdPeT = (
    ...
    - x**2
    + 5 * x
    + ((5 + params["f"] * v(1) - v(0)) / params["PeT"] + params["f"] * (5 - 2)) / (1 - params["f"])
)
dvdPeTx = -3 * x**2 - 2 * x + 5
dvdPeTxx = -6 * x - 2
...
assert np.isclose(
    dvdPeTComputed,
    (-dvdPeTx + dvdPeTxx / params["PeT"] - vxx / (params["PeT"] ** 2) - params["delta"] * dvdPeT) / params["Le"],
).all()
...
assert np.isclose(
    ...
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * ((1 - u) * (params["gamma"] * params["beta"] * dvdPeT / (1 + params["beta"] * v) ** 2) - dudPeT),
).all()
# Check ddvdPeTdt
assert np.isclose(
    dvdPeTComputed,
...
assert np.isclose(
    ...
    + params["Da"]
    * np.exp(params["gamma"] * params["beta"] * v / (1 + params["beta"] * v))
    * ((1 - u) * (params["gamma"] * params["beta"] * dvdf / (1 + params["beta"] * v) ** 2) - dudf),
).all()
# Check ddvdfdt
assert np.isclose(
    dvdfComputed,
